 ...
 * <p>
 *     This class is extended by all the responses.
 *     It contains the date of the response, a success message, a failure message and a debug message.
 *     The debug message is only shown if the application is running in debug mode.
 *     The throwable is only shown if the application is running in debug mode.
 *     The debug message and the throwable are not shown in the production environment.
